...
//	//	self.Containers = [];
//	//	self.Containers.push({ ID: "54in Pallet", Name: 'Box1', Length: 15, Width: 13, Height: 9, AlgorithmPackingResults: [] });
...
//	//self.GeneratePallets = function () {
//	//       self.Containers([]);
//	//       self.Containers.push(ko.mapping.fromJS({ ID: "1000", Name: 'Pallet', Length: 40, Width: 48, Height: 72, AlgorithmPackingResults: [] }));
//	//   };
...
//	self.AddNewContainer = function (id, algorithmPackingResults) {
//		self.Containers.push({ ID: id, Name: "JLS PALLET", Length: 40, Width: 48, Height: 78, AlgorithmPackingResults: algorithmPackingResults });
//	};
